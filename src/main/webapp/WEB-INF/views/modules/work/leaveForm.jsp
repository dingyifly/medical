...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/work/leave/">请假列表</a></li>
		<li class="active"><a href="${ctx}/work/leave/form?id=${leave.id}">请假<shiro:hasPermission name="work:leave:edit">${not empty leave.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="work:leave:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="leave" action="${ctx}/work/leave/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="work:leave:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
