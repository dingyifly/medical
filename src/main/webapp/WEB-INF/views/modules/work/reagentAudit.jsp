...
<body>
	...
	<form:form id="inputForm" modelAttribute="reagentRecord" action="${ctx}/work/reagent/addRecord" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="useDate" name="useDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
						value="${reagentRecord.useDate}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">使用类型：</label>
			<div class="controls">
				<form:radiobuttons path="useFlag" items="${fns:getDictList('use_flag')}" 
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="project" htmlEscape="false" rows="4" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">说明：</label>
			<div class="controls">
				<form:textarea path="instructions" htmlEscape="false" rows="4" class="input-xxlarge "/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasAnyPermissions name="work:reagent:edit, work:reagent:use">
